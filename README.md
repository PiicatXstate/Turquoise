...
## 介绍一下
Turquoise  
本地Epub阅读工具，专为文言文阅读而生   
使用Vue3开发   
我们自带为文言文学习的几项功能  
包含AI查询提问，查词系统，小说注释系统  
可以大幅提升小说阅读的效率  
2025.8.25  Turquoise 1.0.0  
个人还是不太满意这个效果，当然也只能暂时弃坑了，有缘再更新
## 小说一句
...
`2025.8.23` 修复error，完善query样式，添加 查词 和 问AI 的显示逻辑 增加滑动翻页  
`2025.8.24` 修复移动端无法添加释义的BUG  
`2025.8.25` 完全修复注释相关的BUG 
## 预览图
主界面
